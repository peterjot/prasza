...
>>>>>>> 80c897242124cd1b670bf013d36d4b33f6135767
...
Na ten moment największym problemem jest poprawne parsowanie pliku Solidity. W celu polepszenia wyników dopasowywania można ulepszyć aktualny parser tak, aby podczas parsowania ignorował sygnatury funkcji, które nie są dziedziczone przez finalny kontrakt lub można skorzystać z innych gotowych rozwiązań do parsowania plików Solidity. Najprostszym sposobem będzie wykorzystanie kompilatora solc, który po kompilacji zwraca ABI (Application Binary Interface) dla danego kontraktu. 

ABI jest to standardowy sposób komunikacji w Ethereum, który informuje jak wywoływać funkcje na kodzie bajtowym. Specyfikacja ABI przechowuje nazwy i parametry funkcji, na podstawie których można łatwo uzyskać selektory i sygnatury funkcji. 
